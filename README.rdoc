...
Gem that allows you to encrypt passwords using the public key of a list of chef
nodes.  This allows only those chef nodes to decrypt the password.
...
you can create a new instance of ChefKeepass.
...
== Example Code
  ...
  keepass = ChefKeepass.new("passwords")
  user = keepass.user("Administrator")
