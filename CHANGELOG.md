...
## [v4.1.10](https://github.com/chef/chef-vault/tree/v4.1.10) (2022-04-12)
...
#### Merged Pull Requests
- Update pry-stack_explorer requirement from ~&gt; 0.4.0 to ~&gt; 0.6.1 [#395](https://github.com/chef/chef-vault/pull/395) ([dependabot[bot]](https://github.com/dependabot[bot])) <!-- 4.1.10 -->
